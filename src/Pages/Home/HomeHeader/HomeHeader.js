        ...
        <div className="hero my-14 py-20 bg-slate-900 min-h-[80vh] ">
            <div className="hero-content flex-col lg:flex-row-reverse  ">
                ...
                <div className='text-white w-full lg:mr-20'>
                    ...
                    <Link to='signup'>  <button className="btn btn-primary bg-gradient-to-r from-primary to-secondary text-white hover:shadow-secondary hover:shadow-md">start</button></Link>
                </div>
            </div>
        </div >
    );
